...
use App\Actions\Forms\RenderEffectForm;
use App\Actions\Handler\HandleEffects;
...
class EffectCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Blur, pixelate, greyscale, sepia, sharpen.';
